		...
		<section className="flex flex-col gap-2">
			...
			<div
				className={classNames(
					...
					'border-2 flex border-white aspect-square w-full relative before:absolute before:w-full before:h-full before:top-0 before:bg-white overflow-hidden before:transition-all'
				)}
			>
				<CurrentTurnScene />
			</div>
